...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 4efb0981-d263-48e1-ba04-c8e0425d6257
```

> `4efb0981-d263-48e1-ba04-c8e0425d6257` is the password of the certificate, you can change it to any password you want.
